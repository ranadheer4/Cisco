...
public class writeTheDataInExecel2 {
	...
	private static void getData() throws  InterruptedException, Throwable {
		...
		FileInputStream fis= new FileInputStream("C:\\Users\\RanadheerDurgi\\Downloads\\Projcet\\Cicso\\CompanyData.xls");
		...
		while(rows.hasNext()) {
			...
			rows.next();
			FileOutputStream fo = new FileOutputStream("C:\\Users\\RanadheerDurgi\\Downloads\\Projcet\\Cicso\\CompanyData.xls");
			workbook.write(fo);
			fis.close();
			fo.close();
			i++;
